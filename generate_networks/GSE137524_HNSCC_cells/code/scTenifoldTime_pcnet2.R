...
dta <- readRDS("generate_networks/GSE137524_HNSCC_cells/data/dta_rep2.rds")
sudotime <- readRDS("generate_networks/GSE137524_HNSCC_cells/data/sudotime2.rds")
...
saveRDS(res, paste0(
  "generate_networks/GSE137524_HNSCC_cells/results/networks/res_pcnet2_ngroup",
  n_group, ".rds"
))